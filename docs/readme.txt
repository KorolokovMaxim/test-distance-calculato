...
Сначало нужно загрузить файл с данными
...
Описание тестовой задачи
    ...
    (Загрузка производиться POST методом , через Postman или т.п. файл для загрузки находиться в корне название file.xml)
